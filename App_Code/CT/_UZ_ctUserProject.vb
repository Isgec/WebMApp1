...
Namespace SIS.CT
  Partial Public Class ctUserProject
    ...
    Public ReadOnly Property DeleteWFEnable() As Boolean
      ...
      End Get
    End Property
    Public Shared Function DeleteWF(ByVal UserID As String, ByVal ProjectID As String) As SIS.CT.ctUserProject
      Dim Results As SIS.CT.ctUserProject = ctUserProjectGetByID(UserID, ProjectID)
      Return Results
    End Function
