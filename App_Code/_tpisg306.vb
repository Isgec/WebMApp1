...
Namespace SIS.CT
  ...
  Partial Public Class tpisg306
    ...
    Public Shared Function tpisg306GetNewRecord() As SIS.CT.tpisg306
      Return New SIS.CT.tpisg306()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function tpisg306GetByID(ByVal t_csdc As String, ByVal t_ccod As String) As SIS.CT.tpisg306
      ...
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetFDBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          Cmd.CommandText = "sptpisg306SelectByID"
    ...
    Public Shared Function tpisg306SelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal t_ccod As String) As List(Of SIS.CT.tpisg306)
      Dim Results As List(Of SIS.CT.tpisg306) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetFDBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          If SearchState Then
            Cmd.CommandText = "sptpisg306SelectListSearch"
            SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@KeyWord", SqlDbType.NVarChar, 250, SearchText)
          Else
            Cmd.CommandText = "sptpisg306SelectListFilteres"
          ...
          _RecordCount = -1
          Results = New List(Of SIS.CT.tpisg306)()
          Con.Open()
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          While (Reader.Read())
            Results.Add(New SIS.CT.tpisg306(Reader))
          End While
          Reader.Close()
      ...
      Return Results
    End Function
    Public Shared Function tpisg306SelectCount(ByVal SearchState As Boolean, ByVal SearchText As String, ByVal t_ccod As String) As Integer
      Return _RecordCount
    End Function
      'Select By ID One Record Filtered Overloaded GetByID
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function tpisg306GetByID(ByVal t_csdc As String, ByVal t_ccod As String, ByVal Filter_t_ccod As String) As SIS.CT.tpisg306
      Return tpisg306GetByID(t_csdc, t_ccod)
    End Function
