...
Namespace SIS.CT
  Partial Public Class tpisg308
    ...
    Public ReadOnly Property Deleteable() As Boolean
      ...
      End Get
    End Property
    Public Shared Function UZ_tpisg308SelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal t_ccod As String) As List(Of SIS.CT.tpisg308)
      ...
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetFDBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          Cmd.CommandText = "select * from ttpisg308200 where t_ccod='" & t_ccod & "'"
      ...
      Return Results
    End Function
    Public Shared Function UZ_tpisg308Total(ByVal t_ccod As String) As SIS.CT.tpisg308
      ...
      Sql &= " from ttpisg308200 "
      Sql &= " where t_ccod='" & t_ccod & "'"
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetFDBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.Text
          Cmd.CommandText = Sql
          Results = New SIS.CT.tpisg308
          Con.Open()
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          While (Reader.Read())
