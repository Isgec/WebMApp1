...
Namespace SIS.CT
  ...
  Partial Public Class tpisg307
    ...
    Public Shared Function tpisg307GetNewRecord() As SIS.CT.tpisg307
      Return New SIS.CT.tpisg307()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function tpisg307GetByID(ByVal t_csdc As String, ByVal t_ccod As String) As SIS.CT.tpisg307
      ...
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetFDBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          Cmd.CommandText = "sptpisg307SelectByID"
    ...
    Public Shared Function tpisg307SelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal t_ccod As String) As List(Of SIS.CT.tpisg307)
      Dim Results As List(Of SIS.CT.tpisg307) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetFDBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          If SearchState Then
            Cmd.CommandText = "sptpisg307SelectListSearch"
            SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@KeyWord", SqlDbType.NVarChar, 250, SearchText)
          Else
            Cmd.CommandText = "sptpisg307SelectListFilteres"
          ...
          _RecordCount = -1
          Results = New List(Of SIS.CT.tpisg307)()
          Con.Open()
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          While (Reader.Read())
            Results.Add(New SIS.CT.tpisg307(Reader))
          End While
          Reader.Close()
      ...
      Return Results
    End Function
    Public Shared Function tpisg307SelectCount(ByVal SearchState As Boolean, ByVal SearchText As String, ByVal t_ccod As String) As Integer
      Return _RecordCount
    End Function
      'Select By ID One Record Filtered Overloaded GetByID
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function tpisg307GetByID(ByVal t_csdc As String, ByVal t_ccod As String, ByVal Filter_t_ccod As String) As SIS.CT.tpisg307
      Return tpisg307GetByID(t_csdc, t_ccod)
    End Function
