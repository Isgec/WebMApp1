...
Namespace SIS.CT
  ...
  Partial Public Class tpisg308
    ...
    Public Shared Function tpisg308GetNewRecord() As SIS.CT.tpisg308
      Return New SIS.CT.tpisg308()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function tpisg308GetByID(ByVal t_csdc As String, ByVal t_ccod As String) As SIS.CT.tpisg308
      Dim Results As SIS.CT.tpisg308 = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetFDBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "sptpisg308SelectByID"
          ...
          If Reader.Read() Then
            Results = New SIS.CT.tpisg308(Reader)
          End If
          Reader.Close()
        End Using
      End Using
    ...
    Public Shared Function tpisg308SelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal t_ccod As String) As List(Of SIS.CT.tpisg308)
      Dim Results As List(Of SIS.CT.tpisg308) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetFDBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          If SearchState Then
            Cmd.CommandText = "sptpisg308SelectListSearch"
            SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@KeyWord", SqlDbType.NVarChar, 250, SearchText)
          Else
            Cmd.CommandText = "sptpisg308SelectListFilteres"
          ...
          _RecordCount = -1
          Results = New List(Of SIS.CT.tpisg308)()
          Con.Open()
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          While (Reader.Read())
            Results.Add(New SIS.CT.tpisg308(Reader))
          End While
          Reader.Close()
      ...
      Return Results
    End Function
    Public Shared Function tpisg308SelectCount(ByVal SearchState As Boolean, ByVal SearchText As String, ByVal t_ccod As String) As Integer
      Return _RecordCount
    End Function
      'Select By ID One Record Filtered Overloaded GetByID
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function tpisg308GetByID(ByVal t_csdc As String, ByVal t_ccod As String, ByVal Filter_t_ccod As String) As SIS.CT.tpisg308
      Return tpisg308GetByID(t_csdc, t_ccod)
    End Function
