...
Namespace SIS.CT
  ...
  Partial Public Class tpisg303
    ...
    Public Shared Function tpisg303GetNewRecord() As SIS.CT.tpisg303
      Return New SIS.CT.tpisg303()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function tpisg303GetByID(ByVal t_ccod As String, ByVal t_srno As Int32) As SIS.CT.tpisg303
      Dim Results As SIS.CT.tpisg303 = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetFDBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "sptpisg303SelectByID"
          ...
          If Reader.Read() Then
            Results = New SIS.CT.tpisg303(Reader)
          End If
          Reader.Close()
        End Using
      End Using
    ...
    Public Shared Function tpisg303SelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal t_ccod As String) As List(Of SIS.CT.tpisg303)
      Dim Results As List(Of SIS.CT.tpisg303) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetFDBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          If SearchState Then
            Cmd.CommandText = "sptpisg303SelectListSearch"
            SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@KeyWord", SqlDbType.NVarChar, 250, SearchText)
          Else
            Cmd.CommandText = "sptpisg303SelectListFilteres"
          ...
          _RecordCount = -1
          Results = New List(Of SIS.CT.tpisg303)()
          Con.Open()
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          While (Reader.Read())
            Results.Add(New SIS.CT.tpisg303(Reader))
          End While
          Reader.Close()
      ...
      Return Results
    End Function
    Public Shared Function tpisg303SelectCount(ByVal SearchState As Boolean, ByVal SearchText As String, ByVal t_ccod As String) As Integer
      Return _RecordCount
    End Function
      'Select By ID One Record Filtered Overloaded GetByID
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function tpisg303GetByID(ByVal t_ccod As String, ByVal t_srno As Int32, ByVal Filter_t_ccod As String) As SIS.CT.tpisg303
      Return tpisg303GetByID(t_ccod, t_srno)
    End Function
