...
Namespace SIS.CT
  Partial Public Class tpisg304
    ...
    Public ReadOnly Property Deleteable() As Boolean
      ...
      End Get
    End Property
    Public Shared Function UZ_tpisg304SelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal t_ccod As String) As List(Of SIS.CT.tpisg304)
      ...
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetFDBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          Cmd.CommandText = "select * from ttpisg304200 where t_ccod='" & t_ccod & "'"
