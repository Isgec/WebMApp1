...
Namespace SIS.CT
  ...
  Partial Public Class tpisg302
    ...
    Public Shared Function tpisg302GetNewRecord() As SIS.CT.tpisg302
      Return New SIS.CT.tpisg302()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function tpisg302GetByID(ByVal t_ccod As String, ByVal t_srno As Int32) As SIS.CT.tpisg302
      Dim Results As SIS.CT.tpisg302 = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetFDBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "sptpisg302SelectByID"
          ...
          If Reader.Read() Then
            Results = New SIS.CT.tpisg302(Reader)
          End If
          Reader.Close()
        End Using
      End Using
    ...
    Public Shared Function tpisg302SelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal t_ccod As String) As List(Of SIS.CT.tpisg302)
      Dim Results As List(Of SIS.CT.tpisg302) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetFDBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          If SearchState Then
            Cmd.CommandText = "sptpisg302SelectListSearch"
            SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@KeyWord", SqlDbType.NVarChar, 250, SearchText)
          Else
            Cmd.CommandText = "sptpisg302SelectListFilteres"
      ...
      Return Results
    End Function
    Public Shared Function tpisg302SelectCount(ByVal SearchState As Boolean, ByVal SearchText As String, ByVal t_ccod As String) As Integer
      Return _RecordCount
    End Function
      'Select By ID One Record Filtered Overloaded GetByID
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function tpisg302GetByID(ByVal t_ccod As String, ByVal t_srno As Int32, ByVal Filter_t_ccod As String) As SIS.CT.tpisg302
      Return tpisg302GetByID(t_ccod, t_srno)
    End Function
