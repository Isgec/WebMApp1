<%@ Page Language="VB" MasterPageFile="~/Sample.master" AutoEventWireup="False" ClientIDMode="Static" EnableEventValidation = "false" CodeFile="mGctEstActivity.aspx.vb" Inherits="mGctEstActivity" title="Maintain List: Estimation Activity" %>
<asp:Content ID="None" ContentPlaceHolderID="cphMain" runat="server">
        <script type="text/javascript">
          function apply_filter() {
            ...
            cde.set_contextKey(txt + '|CT_ESTIMATION');
...
<asp:Content ID="CPHctPActivity" ContentPlaceHolderID="cph1" runat="Server">
  <div class="container">
    <div class="container text-center">
      <h3>
        <asp:Label ID="LabelctPActivity" runat="server" Text="Project Progress Update-Estimation"></asp:Label></h3>
    </div>
    <asp:UpdatePanel ID="UPNLctPActivity" runat="server">
      <ContentTemplate>
        <div class="form-group">
          ...
          <div class="input-group mb-3">
            ...
            <AJX:CascadingDropDown
              ...
              Category="t_iref"
              LoadingText="Loading. . ."
              ContextKey="dummy|CT_ESTIMATION"
              UseContextKey="True" 
              runat="server" />
          </div>
          <div class="input-group mb-3">
        ...
        <asp:ObjectDataSource
          ...
          SelectMethod="UZ_ctEstActivitySelectList"
