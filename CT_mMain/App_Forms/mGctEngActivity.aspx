<%@ Page Language="VB" MasterPageFile="~/Sample.master" AutoEventWireup="False" ClientIDMode="Static" EnableEventValidation = "false" CodeFile="mGctEngActivity.aspx.vb" Inherits="mGctEngActivity" title="Maintain List: Projects Activity" %>
<asp:Content ID="None" ContentPlaceHolderID="cphMain" runat="server">
        <script type="text/javascript">
          function apply_filter() {
            ...
            cde.set_contextKey(txt + '|CT_ENGG');
...
<asp:Content ID="CPHctPActivity" ContentPlaceHolderID="cph1" runat="Server">
  <div class="container">
    <div class="container text-center">
      <h3>
        <asp:Label ID="LabelctPActivity" runat="server" Text="Project Progress Update-Engineering"></asp:Label></h3>
    </div>
    <asp:UpdatePanel ID="UPNLctPActivity" runat="server">
      <ContentTemplate>
        ...
        <asp:ObjectDataSource
          ...
          SelectMethod="UZ_ctEngActivitySelectList"
