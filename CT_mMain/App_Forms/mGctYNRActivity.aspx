<%@ Page Language="VB" MasterPageFile="~/Sample.master" AutoEventWireup="False" ClientIDMode="Static" EnableEventValidation = "false" CodeFile="mGctYNRActivity.aspx.vb" Inherits="mGctYNRActivity" title="Maintain List: Projects Activity" %>
...
<asp:Content ID="CPHctPActivity" ContentPlaceHolderID="cph1" runat="Server">
  <div class="container">
    <div class="container text-center">
      <h3>
        <asp:Label ID="LabelctPActivity" runat="server" Text="Project Progress Update-Manufactuaring YNR"></asp:Label></h3>
    </div>
    <asp:UpdatePanel ID="UPNLctPActivity" runat="server">
      <ContentTemplate>
        ...
        <asp:ObjectDataSource
          ...
          SelectMethod="UZ_ctYNRActivitySelectList"
